...
export const ChatPanel: React.FC<ChatPanelProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-neutral-800 shadow-sm chat-panel">
      <div className="flex-1 overflow-y-auto p-2 lg:p-4 space-y-3 pb-20 lg:pb-4">
      ...
      <form
        ...
        className="fixed lg:sticky bottom-[72px] lg:bottom-0 left-0 right-0 p-3 bg-neutral-50 dark:bg-neutral-800 border-t border-neutral-200 dark:border-neutral-700 shadow-md z-10"
      >
      ...
      {currentModePreset && (
        currentModePreset.inputDisabled ? (
          ...
          <input
            ...
            className="flex-1 rounded-lg border border-neutral-200 dark:border-neutral-700 px-3 py-3
                     focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-accent-500 focus:border-transparent 
                     shadow-sm hover:shadow transition-shadow duration-300 text-base lg:text-sm min-h-[48px]
          ...
          <div className="flex gap-2 lg:flex-shrink-0">
            <button
              type="submit"
              className="btn-primary min-h-[48px] px-4 rounded-lg shadow-sm hover:shadow transition-shadow duration-300"
            ...
            <button
              ...
              className="btn-secondary min-h-[48px] px-4 rounded-lg shadow-sm hover:shadow transition-shadow duration-300"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
