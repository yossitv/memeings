...
export const ChatPanel: React.FC<ChatPanelProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-neutral-800 shadow-sm chat-panel">
      <div className="flex-1 overflow-y-auto p-2 lg:p-4 space-y-4 pb-32 lg:pb-4">
      ...
      <form
        ...
        className="fixed lg:sticky bottom-20 lg:bottom-0 left-0 right-0 p-3 lg:p-4 bg-neutral-50 dark:bg-neutral-800 border-t border-neutral-200 dark:border-neutral-700 z-10"
      >
      ...
      {currentModePreset && (
        currentModePreset.inputDisabled ? (
          ...
          <input
            ...
            className="flex-1 rounded-lg border border-neutral-200 dark:border-neutral-700 px-4 py-4 lg:py-2 
                     focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-accent-500 focus:border-transparent 
                     shadow-sm text-base lg:text-sm min-h-[56px]
